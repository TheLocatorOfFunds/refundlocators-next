  ...
  return (
    <motion.div {...resultEnter} style={{ marginTop: 32 }}>
      ...
      <p style={{ fontSize: 14, color: 'var(--cream-45)', marginBottom: 20, lineHeight: 1.6 }}>
        You have a statutory right to claim this money. Our attorneys handle the legal filing on your behalf for a contingency fee stated in your written agreement before we file. Zero upfront cost — if we recover nothing, you owe nothing.
      </p>
...
function ResultLikely({ result, onClaim, onChat }: {
  ...
  return (
    <motion.div {...resultEnter} style={{ marginTop: 32 }}>
      ...
      <p style={{ fontSize: 14, color: 'var(--cream-45)', marginBottom: 20, lineHeight: 1.6 }}>
        The money typically sits with the county Clerk of Courts for 5 years after the sale. If nobody claims it, it escheats to the state. Our attorney files the motion — we cover the filing fees. You pay only if we recover, at the rate stated in your written agreement.
      </p>
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
