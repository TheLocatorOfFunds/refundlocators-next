      ...
      <section className="pass-hero home-hero" data-loaded="1">
        <div className="pass-center home-center">
          ...
          <div className="home-brand">
            ...
            <div className="home-brand-tagline">Built for homeowners · not the leads list</div>
          </div>

          <h1 className="home-headline">
            Lost your home at a foreclosure sale?{' '}
          ...
          <div className="pass-legal home-legal">
            FundLocators LLC · A licensed attorney files every claim · 25% of recovery · $0 upfront
            <br />
